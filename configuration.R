...
# Field Metadata
config_response_column = c('loss')
config_identifer_columns = c('id')
config_categorical_columns = c('cat1', 'cat2', 'cat3', 'cat4', 'cat5',
...
config_continuous_columns = c('cont1', 'cont2', 'cont3', 'cont4', 'cont5',
